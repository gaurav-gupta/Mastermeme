 ...
 */
contract MasterMeme is
    Initializable, ContextUpgradeable,
    AccessControlEnumerableUpgradeable, ERC721Upgradeable, PausableUpgradeable, ERC2981Upgradeable
{
    function initialize(
        string memory name,
        ...
        __MasterMeme_init(name, symbol, baseTokenURI);
    }
    ...
    function __MasterMeme_init(
        ...
        __Pausable_init();
        __MasterMeme_init_unchained(name, symbol, baseTokenURI);
    }

    function __MasterMeme_init_unchained(
        string memory,
        string memory,
        string memory baseTokenURI
    ) internal onlyInitializing {
